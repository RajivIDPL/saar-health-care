      ...
      <div class="row">
         <div class="col-lg-8">
            <div class="about-service">
               <div class="position-relative">
                  <img src="assets/images/service/relationship-issue.html" class="img-fluid"
                     alt="image">
               </div>
               <div class="iq-title-box mt-5 mb-0">
                  <span class="iq-subtitle text-uppercase">REATIONSHIP ISSUE</span>
                  <h3 class="iq-title iq-heading-title mb-2">
                     <span class="right-text text-capitalize">Psychiatrist</span>
                     <span class="left-text text-capitalize fw-light">Treatments</span>
                  </h3>
               ...
               <div class="pt-5">
                  <div class="row mt-5 align-items-center">
                     <div class="col-md-5">
                        <div class="iq-counter iq-counter-no-icon bg-soft-primary p-3">
                           <div class="counter-content">
                              <h3 class="counter mt-0 mb-3 text-primary fw-500">1000+</h3>
                              <h4 class="counter-title mb-2 fw-normal">Operations Done</h4>
                              <p class="counter-text m-0 text-body">Lorem Ipsum is simply dummy text of the
                        ...
                        <div>
                           <div class="wrapper-progress">
                              <div class="percentage-progress d-flex justify-content-between">
                                 <h6 class="mb-2 text-body">Immunotherapy</h6>
                                 <div><span>91%</span></div>
                              </div>
                           </div>
                           <div class="progress" style="height:10px">
                              <div class="progress-bar bg-primary" role="progressbar"
                                 style="width: 91%; height:10px" aria-valuenow="25" aria-valuemin="0"
                                 aria-valuemax="100"></div>
                           </div>                        </div>
                        <div class="mt-5">
                           <div class="wrapper-progress">
                              <div class="percentage-progress d-flex justify-content-between">
                                 <h6 class="mb-2 text-body">Hormone
                                                      therapy</h6>
                           ...
                           <div class="progress" style="height:10px">
                              <div class="progress-bar bg-primary" role="progressbar"
                                 style="width: 84%; height:10px" aria-valuenow="25" aria-valuemin="0"
                                 aria-valuemax="100"></div>
                           </div>                        </div>
                        <div class="mt-5">
                           <div class="wrapper-progress">
                              <div class="percentage-progress d-flex justify-content-between">
                                 <h6 class="mb-2 text-body">Targeted
                                                      drug therapy</h6>
                           ...
                           <div class="progress" style="height:10px">
                              <div class="progress-bar bg-primary" role="progressbar"
                                 style="width: 75%; height:10px" aria-valuenow="25" aria-valuemin="0"
                                 aria-valuemax="100"></div>
                           </div>                        </div>
                     </div>
                  </div>
               ...
               <div class="mt-5 pt-md-3 pb-5 border-bottom">
                  <div class="iq-title-box mt-5 mb-0">
                     ...
                     <h4 class="iq-title iq-heading-title mb-2">
                        <span class="right-text text-capitalize">Kivicare Tips For Healthy</span>
                        <span class="left-text text-capitalize fw-light">Children And
                        Families</span>    
                     </h4>
                     <p class="iq-title-desc text-body">
                  ...
                  <div class="accordion" id="main-faq">
                     <div class="accordion-item custom-accordion mb-4 bg-white rounded-0">
                        <h5 class="accordion-header rounded-0" id="heading01">
                           <button class="accordion-button fw-500 text-capitalize" type="button" data-bs-toggle="collapse" data-bs-target="#collapse01" aria-expanded="true" aria-controls="collapse01">
                           Can I trust my tap water? 
                           </button>
                        </h5>
                        <div id="collapse01" class="accordion-collapse collapse show" aria-labelledby="heading01" data-bs-parent="#main-faq">
                     ...
                     <div class="accordion-item custom-accordion mb-4 bg-white rounded-0">
                        <h5 class="accordion-header rounded-0" id="heading02">
                           <button class="accordion-button fw-500 text-capitalize collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse02" aria-expanded="true" aria-controls="collapse02">
                           Is my
                                          microwave giving me cancer? 
                           </button>
                        </h5>
                        <div id="collapse02" class="accordion-collapse collapse" aria-labelledby="heading02" data-bs-parent="#main-faq">
                           <div class="accordion-body">
                     ...
                     <div class="accordion-item custom-accordion mb-4 bg-white rounded-0">
                        <h5 class="accordion-header rounded-0" id="heading03">
                           <button class="accordion-button fw-500 text-capitalize collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse03" aria-expanded="true" aria-controls="collapse03">
                           How long
                                          am I
                                          contagious when I have the flu or a cold?
                           </button>
                        </h5>
                        <div id="collapse03" class="accordion-collapse collapse" aria-labelledby="heading03" data-bs-parent="#main-faq">
                           <div class="accordion-body">

  ...
  <body class=" body-bg landing-pages">
    ...
    <main class="main-content">
      <div class="position-relative">
        ...
        <!--bread-crumb-->
          <div class="iq-breadcrumb bg-soft-primary">
             <div class="container">
                <nav aria-label="breadcrumb" class="text-center">
                   <h2 class="title">Some questions about nutrition?</h2>
...
<div class="section-padding">
   <div class="container">
      <div class="row">
         <div class="col-xl-8">
            <div class="iq-blog blog-detail position-relative border">
               <a href="blog-details.php" class="blog-image d-block overflow-hidden">
               <img src="assets/images/blog/blog-7.html" alt="blog-image"
                  class="img-fluid w-100" loading="lazy">
               </a>
               <div class="iq-post-details bg-white p-4">
                  <div class="iq-blog-meta">
                     <ul class="list-inline">
                        <li class="position-relative list-inline-item text-uppercase">
                           <a href="blog-author.html">
                           <i class="far fa-user me-2 text-primary" aria-hidden="true"></i>
                  ...
                  <p class="pb-3">Dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                     temporincididunt ut labore et
                  ...
                  <div class="blogquote position-relative bg-soft-primary fst-italic">
                     <p class="text-body">
                     ...
                     <h6 class="text-primary fw-bolder fst-italic text-uppercase">– Simon Sais</h6>
                     <i aria-hidden="true" class="fas fa-quote-right quote-icon position-absolute"></i>
                  </div>
                  <h4 class="mt-4">1. Good Nutrition Improves Well-Being</h4>
                  <p class="mt-3">
                  ...
                  <h4 class="mt-4">2. It’s Expensive To Be Unhealthy</h4>
                  <p class="mt-3">
                  ...
                  <div class="row my-5">
                     <div class="col-md-6">
                        <img src="assets/images/blog/blogdetai-1.html" alt="banner"
                           class="img-fluid" style="transform:none">
                     </div>
                     <div class="col-md-6 mt-5 mt-lg-0 mt-md-0">
                        <img src="assets/images/blog/blogdetai-2.html" alt="banner"
                           class="img-fluid" style="transform:none">
                     </div>
                  </div>
                  <h4 class="mt-4">3. Helps You Manage A Healthy Weight</h4>
                  <p class="mt-3">
                     Eating a poor diet reduces physical and mental health because eating healthy allows people
                     to be more active. Two-thirds of people who eat fresh fruit and vegetables daily report no
                     mental health issues, as reported by the Mental Health Foundation. Compare this to those who
                  ...
                  <h4 class="mt-4">4. Maintains Your Immune System</h4>
                  <p class="mt-3">
                     Eating a poor diet reduces physical and mental health because eating healthy allows people
                     to be more active. Two-thirds of people who eat fresh fruit and vegetables daily report no
                     mental health issues, as reported by the Mental Health Foundation. Compare this to those who
                  ...
                  <ul class="blogtag list-inline mt-5 mb-0">
                     <li class="label d-inline me-2">Tags:</li>
                     <li class="d-inline">
                        <a href="#" class="position-relative">Health Care</a>
                     </li>
                  </ul>
               </div>
            </div>
            <div class="blog-comment mt-5">
               <h4 class="mb-5">1 Comment</h4>
               <div
                  class="comment-wrap d-flex p-5 border position-relative flex-row flex-column flex-lg-row flex-md-row gap-4">
                  <div>
                     <img src="assets/images/blog/avatar.html" alt="author"
                        class="img-fluid">
                  </div>
                  <div class="comments-info">
                     <h5>Admin</h5>
                     <p class="my-2">Mind Blowing</p>
                     <div class="list-inline-item">
                        <i aria-hidden="true" class="far fa-calendar-alt me-1 text-primary small"></i>
                        <a href=" " class="text-uppercase small">March 24, 2022</a>
                     </div>
                     <div class="iq-btn-container">
                        <a class="iq-button text-capitalize" href="javascript:void(0)">
                           <span class="iq-btn-text-holder position-relative">Reply</span>
               ...
               <h4 class="my-5">Leave A Reply</h4>
               <p>Your email address will not be published. Required fields are marked *</p>
               <form method="post" class="mt-5">
                  <div class="custom-form-field">
                     <textarea id="comment" name="comment" placeholder="Comment" required="required"
                        class="form-control"></textarea>
                  </div>
                  <div class="row my-5">
                     <div class="col-lg-4 col-md-6 my-5 my-lg-0">
                        <div class="custom-form-field">
                           <input id="author" name="author" aria-required="true" required="required"
                     ...
                     <div class="col-lg-4 col-md-6 my-5 my-lg-0">
                        <div class="custom-form-field">
                           <input id="url" name="url" placeholder="Website" class="form-control">
                        </div>
                     </div>
                  </div>
                  <label class="mb-5 custom-form-field">
                  <input type="checkbox" required="required"> <span class="checkmark"></span><span>Save my
                  name, email, and website in this browser for the next time I comment.</span>
                  </label>
                  <div class="iq-btn-container">
                     <button type="submit" class="iq-button text-uppercase border-0">
                        <span class="iq-btn-text-holder position-relative">post comment</span>
                        <span class="iq-btn-icon-holder">
                           <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 8 8" fill="none">
                              <path d="M7.32046 4.70834H4.74952V7.25698C4.74952 7.66734 4.41395 8 4 8C3.58605 8 3.25048 7.66734 3.25048 7.25698V4.70834H0.679545C0.293423 4.6687 0 4.34614 0 3.96132C0 3.5765 0.293423 3.25394 0.679545 3.21431H3.24242V0.673653C3.28241 0.290878 3.60778 0 3.99597 0C4.38416 0 4.70954 0.290878 4.74952 0.673653V3.21431H7.32046C7.70658 3.25394 8 3.5765 8 3.96132C8 4.34614 7.70658 4.6687 7.32046 4.70834Z" fill="currentColor"></path>
                           </svg>
         ...
         <div class="col-xl-4 mt-5 mt-xl-0">
            <div class="widget-area">
               <div class="widget bg-soft-primary widget_search p-5 mb-5">
                  <form method="get" class="search-form" action="#" autocomplete="off">
                     <div class="block-search_inside-wrapper position-relative d-flex">
                        <input type="search" class="w-100 border" placeholder="Search" required="">
                        <button type="submit" class="block-search_button">
                           <svg class="icon-20" width="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="widget bg-soft-primary iq-widget-menu p-5 mb-5">
                  <h5 class="widget-title position-relative mb-5 pb-3 letter-spacing-1 fw-normal">Recent Post</h5>
                  <ul class="p-0 m-0">
                     <li class="d-flex gap-4">
                        <div class="img-holder">
                           <a href="#">
                           <img src="assets/images/blog/blog-1.html" alt="" class="img-fluid">
                           </a>
                        </div>
                        <div class="post-blog">
                           <ul class="list-inline mb-2">
                              <li class="list-inline-item border-0 mb-0 pb-0">
                                 <a href="#"> <i class="far fa-calendar-alt me-2" aria-hidden="true"></i>September 23, 2022
                                 </a>
                              </li>
                              <li class="list-inline-item border-0 mb-0 pb-0">
                                 <a href="#"> <i class="far fa-user me-1" aria-hidden="true"></i>goldenmace </a>
                              </li>
                           </ul>
                           <a class="new-link" href="blog-details.php">
                              <h6 class="post-title mb-0">OPD cover gaining popularity among Indian consumers</h6>
                           </a>
                        </div>
                     </li>
                     <li class="d-flex gap-4">
                        <div class="img-holder">
                           <a href="#">
                           <img src="assets/images/blog/blog-2.html" alt="" class="img-fluid ">
                           </a>
                        </div>
                        <div class="post-blog">
                           <ul class="list-inline mb-2">
                              <li class="list-inline-item border-0 mb-0 pb-0">
                                 <a href="#"> <i class="far fa-calendar-alt me-1" aria-hidden="true"></i>September 23, 2022
                                 </a>
                              </li>
                              <li class="list-inline-item border-0 mb-0 pb-0">
                                 <a href="#"> <i class="far fa-user me-1" aria-hidden="true"></i>goldenmace </a>
                           ...
                           <a class="new-link" href="blog-details.php">
                              <h6 class="post-title mb-0">Why Is Dry Eye So Difficult To Treat?</h6>
                           </a>
                        </div>
                     </li>
                     <li class="d-flex gap-4">
                        <div class="img-holder">
                           <a href="#">
                           <img src="assets/images/blog/blog-3.html" alt="" class="img-fluid ">
                           </a>
                        </div>
                        <div class="post-blog">
                           <ul class="list-inline mb-2">
                           ...
                           <a class="new-link" href="blog-details.php">
                              <h6 class="post-title mb-0">Circulating vaccine-derived poliovirus type 2 (cVDPV2) – Algeria
                              </h6>
                           </a>
                        </div>
                     </li>
               ...
               <div class="widget bg-soft-primary widget_categories p-5 mb-5">
                  <h5 class="widget-title position-relative mb-5 pb-3 letter-spacing-1 fw-normal">Categories</h5>
                  <ul class="p-0 m-0 list-unstyled">
                     <li class="cat-item">
                        <a href="blog-category.html" class="position-relative">Disease</a>
                        <span class="archiveCount">2</span>
                     </li>
                     <li class="cat-item">
                        <a href="blog-category.html" class="position-relative">Eye Care</a>
                        <span class="archiveCount">5</span>
                     </li>
                     <li class="cat-item">
                        <a href="blog-category.html" class="position-relative">Health Care</a>
                        <span class="archiveCount">4</span>
                     </li>
                     <li class="cat-item">
                        <a href="blog-category.html" class="position-relative">Uncategorized</a>
                        <span class="archiveCount">1</span>
                     </li>
                  </ul>
               </div>
               <div class="widget bg-soft-primary widget_tags p-5 mb-5">
                  <h5 class="widget-title position-relative mb-5 pb-3 letter-spacing-1 fw-normal">Tags</h5>
                  <ul class="p-0 m-0 list-unstyled">
                     <li class="cat-item mb-0 pb-0 border-0 d-inline">
                        <a href="blog-tag.html" class="position-relative">Eyecare</a>
                     </li>
                     <li class="cat-item mb-0 pb-0 border-0 d-inline">
                        <a href="blog-tag.html" class="position-relative">Healthcare</a>
                     </li>
                     <li class="cat-item mb-0 pb-0 border-0 d-inline">
                        <a href="blog-tag.html" class="position-relative">Health News</a>
                     </li>
                     <li class="cat-item mb-0 pb-0 border-0 d-inline">
                        <a href="blog-tag.html" class="position-relative">Insurance</a>
                     </li>
                     <li class="cat-item mb-0 pb-0 border-0 d-inline">
                        <a href="blog-tag.html" class="position-relative">Vaccine</a>
                     </li>
                  </ul>
               </div>
               <div class="widget bg-soft-primary widget_contact p-5 mb-5">
                  <h5 class="widget-title position-relative mb-5 pb-3 letter-spacing-1 fw-normal">Reach Us</h5>
                  <ul class="p-0 m-0 list-unstyled">
                     <li class="d-flex">
                        <a href="tel:+0123456789" class="d-flex gap-3">
                           <span class="flex-shrink-0">
                              <svg xmlns="http://www.w3.org/2000/svg" class="icon-20" viewBox="0 0 27 27" fill="none">
                                 <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="27" height="27">
                     ...
                     <li class="d-flex">
                        <a href="mailto:saarahealthcarefbd@gmail.com" class="d-flex gap-3">
                           <span class="flex-shrink-0">
                              <svg xmlns="http://www.w3.org/2000/svg" class="icon-20" width="28" height="25" viewBox="0 0 28 25" fill="none">
                                 <path fill-rule="evenodd" clip-rule="evenodd"
                                 ...
                                 <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="28" height="25">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.25 0.5H27.1249V24.875H0.25V0.5Z"
                                       fill="white"></path>
                                 </mask>
                                 <g>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                           ...
                           <span>saarahealthcarefbd@gmail.com</span>
                        </a>
                     </li>
                     <li class="d-flex">
                        <a class="d-flex gap-3">
                           <span class="flex-shrink-0">
                              <svg xmlns="http://www.w3.org/2000/svg" class="icon-20" width="30" height="28" viewBox="0 0 21 25" fill="none">
                                 <path fill-rule="evenodd" clip-rule="evenodd"
